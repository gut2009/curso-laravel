...
<body
    ...
    <span class="preheader"
        style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Esse é o texto do pré-cabeçalho. Alguns clientes mostrarão este texto como uma prévia.</span>
