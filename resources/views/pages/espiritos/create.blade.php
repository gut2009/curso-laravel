...
<div class="row mt-4">
  ...
  <div class="col-10">
    <div class="container mt-2 mb-2 fundo">
      <form class="form" method="POST" action="{{ route('espirito.store') }}">
        @csrf
        ...
        <div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-1 pb-1 mb-2 border-bottom btnPages">
          <h2 class="th2">Cadastrar novo Autor Espiritual</h2>
        </div>
        <div class="row">
          <div class="col-12">
            <label class="form-label">Nome d o Autor Espiritual</label>
